...
class hotel {
	...
	public:
			...
			void book();				//to book a room
			void view(); 		//to display the customer record
			void rooms();			//to display allotted rooms
			void edit();			//to edit the customer record
			int check(int);	     	//to check room status
			void change(int);		//to change the record
			void trunc_rec(int);   //to delete the record
